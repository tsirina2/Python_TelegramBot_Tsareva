# Задание для студентов «Проект: разработайте Telegram-бот с функцией календаря, часть 1»
<aside>
...
5. Сделайте коммит кода в ветке задания.
6. Предоставьте код-ревьюеру доступ к вашему проекту.
