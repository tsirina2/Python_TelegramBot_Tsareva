...
2. Запустите PostgreSQL. Запуск различается в зависимости от операционной системы.
   <details>
    <summary>Подсказка: как запустить PostgreSQL на Windows</summary>
   ...
   - Инициализируйте директорию баз данных на локальном компьютере. Для этого введите команду:
    ...
    <details>
    <summary>Подсказка: как запустить PostgreSQL на Linux</summary>
   ...
   - Инициализируйте директорию баз данных на локальном компьютере. Для этого введите команду:
    ...
    <details>
    <summary>Подсказка: как запустить PostgreSQL на macOS</summary>
...
3. Создайте новую базу данных.
   ...
   <details>
    <summary>Подсказка: как создать базу данных</summary>
...
1. **Предусмотрите хранение информации о пользователе.** 
   Необходимо хранить информацию о каждом пользователе (например его идентификатор Telegram) в базе данных. Вы можете добавить новый столбец в таблицу «события» для хранения идентификатора пользователя, который создал события.
