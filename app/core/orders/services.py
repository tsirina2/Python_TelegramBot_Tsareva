...
from app.core.orders.repositories import OrderRepository
...
@dataclass  # ← ADD THIS
class OrderService:
    repository: OrderRepository  # Now this will be set automatically
    ...
    async def send_order_to_waiters(self, order_id: int) -> None:  # Removed extra space
    ...
    async def mark_order_done(self, order_id: int) -> None:
        return await self.repository.set_order_status(order_id, OrderStatusEnum.done)  # Check casing
